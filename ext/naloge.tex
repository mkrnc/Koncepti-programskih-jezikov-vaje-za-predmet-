...
set : int -> 'a -> unit  (dodaj element tipa 'a k elementom
                         z indeksom i)
del : int -> 'a -> unit  (izbri\v si el. tipa 'a iz 
                         mnozice elementov z indeksom i)
\end{lstlisting}
...
Vsak geometrijski objekt naj ima funkcijo \lstinline{premakni_se : int -> int -> unit}, kjer predstavljata parametra premika po $x$ in $y$ osi. 
...
\end{lstlisting}
  ...
  Napi\v si metodo \lstinline{izpisi\_liste}, ki izpi\v se imena in tipe
