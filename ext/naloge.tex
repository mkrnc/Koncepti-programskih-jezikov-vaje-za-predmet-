...
\begin{ex}
Geometrijski objekt je definiran z virtualnim razredom geo, ki vsebuje definiciji naslednjih virtualnih metod.
...
\item Z uporabo pred definiranega abstraktnega razreda tocka definiraj parametriziran razred \lstinline{'a slika}, kjer tip \texttt{'a} spet predstavlja tip barve to\v ck slike. 
